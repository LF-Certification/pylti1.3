from pylti1p3.contrib.fastapi import FastAPIRequest, FastAPICookieService, \
...
class FastAPIMixin(object):
    ...
    def _get_request(self, login_request, login_response, request_is_secure=False, post_data=None,
        ...
        return FastAPIRequest(request_data=post_launch_data,
                            cookies=cookies,
                            session=session,
    ...
    def _make_oidc_login(self, uuid_val=None, tool_conf_cls=None, secure=False, tool_conf_extended=False,
        ...
        with patch('flask.redirect') as mock_redirect:
            ...
            with patch.object(FastAPIOIDCLogin, "_get_uuid", autospec=True) as get_uuid,\
                    patch.object(FastAPIOIDCLogin, "_generate_nonce", autospec=True) as generate_nonce,\
                    patch.object(FastAPIOIDCLogin, 'get_response', autospec=True) as get_response:
                ...
                oidc_login = FastAPIOIDCLogin(request, tool_conf,
